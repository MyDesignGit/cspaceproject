...
<section class="clearfix formContainer">
    <div class="col col_4 ccspaceFormHeadCol">
        <h3 class="subjectCentre bigCapHeading">affillate</br>partner</h3>
    </div>
    <div class="col col_4 ccspaceFormCol">
        <form class="fromwidth" id="app">
            ...
            <div v-if="step_0" class="rightanimation">
                <p>C Space is looking for beneficial partnerships with organisations that can build a wide base of an engaged audience. How can you help?</p>
                <!-- Button -->
            ...
            <div v-if="step_1" class="rightanimation">
                ...
                <div class="input-group" class="rightanimation2">
            ...
            <div v-if="step_3" class="rightanimation">
                <div class="input-group">
                    <label>links to your client testimonials.</label>
                    <div class="radioCheckbox-wrap">
                        <input class="mt-20" v-model="tlinks1" type="text" required="email" />
                        <input class="mt-20"  v-model="tlinks2" type="text" required="email" />
                        <input  class="mt-20" v-model="tlinks2" type="text" required="email" />
                    </div>
                     <div class="ccspaceFormBtns clearfix">
